...
- Path to task card in `1 | Wiki/1.2 | Initiatives/backlog/`

## Steps

1. Read the full task card
2. Read all wiki pages listed in `wiki:` frontmatter
3. Read `9 | Reference/comms.md` if the output involves writing
4. Read `9 | Reference/identity.md` if voice or personal context matters
5. Produce the output following the handoff prompt exactly
6. Write output to `1 | Wiki/1.6 | Exports/[kind]/[title].md` with back-links to task and wiki pages used
7. Update the task card: set `output:` to the output file path, move card to `1 | Wiki/1.2 | Initiatives/done/`
